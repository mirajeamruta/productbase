<div class="container">
    <div id='section_viewworkorder' class="table-responsive-md">
        <h2 id="viewWorkOrderHeader" class=" text-center mb-2">View Workorder</h2>
        ...
        <div id="workorderStatus__conatiner">
          ...
          <form method="post" autocomplete="off" action="<?= base_url('Workorder/closeWorkOrderStatus') ?>">
              <input type="text" value="" name="currentWorkorderNo" readonly id="currentWorkOrderNo" />
              <input type="text" value="" name="workorderStatus" readonly id="workorderStatus" />
           ...
           <form method="post" id="deleteWorkOrderForm" autocomplete="off" action="<?= base_url('Workorder/deleteWorkorderNumber') ?>">
            <input type="text" value="" name="currentWorkorderNumber" readonly id="currentWorkOrderNumber" />
                ...
                <tr>
                    ...
                    <td colspan="7" class="text-center" id="clientNameEditable" style="display: none;">
                        <select id="clientNameEditableSelect">
                            ...
                            <option value="<?= $clientnamerecord['name']; ?>"
                                <?php echo ($row['client_name'] === $clientnamerecord['name']) ? 'selected' : '' ?>>
                ...
                <tr>
                    ...
                    <td colspan="7" class="text-center" id="partnerEditable" style="display: none;">
                        <select id="partnerEditableSelect">
                            <option value="">Select</option>
                            <option value="R.E. Balasubramanyam"
                                <?php echo ($row['partner_in_charge'] === "R.E. Balasubramanyam") ? 'selected' : '' ?>>
                                R.E. Balasubramanyam</option>
                            <option value="A.V. Muralisharan"
                                <?php echo ($row['partner_in_charge'] === "A.V. Muralisharan") ? 'selected' : '' ?>>
                                A.V. Muralisharan</option>
                            <option value="N.K.S. Bharath"
                                <?php echo ($row['partner_in_charge'] === "N.K.S. Bharath") ? 'selected' : '' ?>>
                                N.K.S. Bharath</option>
                            <option value="Ashok S Navalgund"
                                <?php echo ($row['partner_in_charge'] === "Ashok S Navalgund") ? 'selected' : '' ?>>
...
<!-- changes I have made in date -->
                        <input type="text" id="start_date" style="border:none" value=" <?php echo date("d-m-Y", strtotime($row['start_date'])); ?>"
                            readonly />
                    </td>
                    ...
                    <td>
                        <input type="date" class="view_workorder_editable" id="targeted_date" name="targeted_date"
                            value="<?php echo $row['targetted_end_date']; ?>" min="<?php echo date("Y-m-d") ?>"
                    ...
                    <td>
                        <input type="date" class="view_workorder_editable" id="deadline_date" name="deadline_date"
                            value="<?php echo $row['deadline']; ?>" min="<?php echo date("Y-m-d") ?>" />
                    ...
                    <th class="wkorderhead" colspan="8">Team Members
                       ...
                       if ($this->session->userdata('usertype') == 'admin'  && isset($row)) {
                        ...
                        <form method="post" autocomplete="off" action="<?= base_url('Workorder/updateData') ?>">
                            ...
                            <input type="text" value="<?php echo $row['workorder_no']; ?>" name="workorder_number"
                                hidden />
                        ...
                        <form method="post" autocomplete="off"
                            action="<?= base_url('Workorder/updateDataAfterDelete') ?>">
        ...
        <button id="close_workorder">Request for close workorder</button>
