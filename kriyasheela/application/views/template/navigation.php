<div class="container-fluid navcontainer">
    <nav class="navbar navbar-expand-lg navbar-fixed-top mb-0 px-0">
        <div class="container-fluid">
            <div class="logo">
                <a id="top" href="#"> <img src="<?= ("http://localhost/kriyasheela-p2/kriyasheela/images/ca_logo.png") ?>" width="95"  height="45">
            	<div>
                    <h6 class="words2" style="margin: -43px 0px 44px 89px;
    font-size: 23px !important; color: #3f3f66; letter-spacing: 1px;font-weight: 600;">BALU & ANAND </h6>

                    <h6 class="words3" style=" margin: -44px 88px 0px;
